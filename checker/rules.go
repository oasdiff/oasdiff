...
func GetAllRules() BackwardCompatibilityRules {
	return BackwardCompatibilityRules{
		...
		newBackwardCompatibilityRule(RequestBodyRemovedId, ERR, RequestBodyRemovedCheck, DirectionRequest, AreaRequestBody, KindExistence, EffectUnknown, nil, "paths.*.*.requestBody:unset"),
