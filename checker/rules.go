...
func GetAllRules() BackwardCompatibilityRules {
	return BackwardCompatibilityRules{
		...
		newBackwardCompatibilityRule(ResponseBodyAllOfRemovedId, WARN, ResponsePropertyAllOfUpdatedCheck, DirectionResponse, AreaSchema, KindStructure, ActionRemove),
		...
		newBackwardCompatibilityRule(ResponsePropertyAllOfRemovedId, WARN, ResponsePropertyAllOfUpdatedCheck, DirectionResponse, AreaSchema, KindStructure, ActionRemove),
