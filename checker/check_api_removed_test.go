...
func TestBreaking_DeletedPath(t *testing.T) {
	...
	requireChange(t, errs, checker.APIPathRemovedWithoutDeprecationId)
...
func TestBreaking_DeletedOp(t *testing.T) {
	...
	require.Len(t, errs, 1)
	requireChange(t, errs, checker.APIRemovedWithoutDeprecationId)
...
func TestBreaking_RemoveBeforeSunset(t *testing.T) {
	...
	require.NotEmpty(t, errs)
	require.Len(t, errs, 1)
	requireChange(t, errs, checker.APIRemovedBeforeSunsetId)
...
func TestBreaking_DeprecationNoSunset(t *testing.T) {
	...
	require.NoError(t, err)
	require.Len(t, errs, 1)
	requireChange(t, errs, checker.APIRemovedWithDeprecationId)
...
func TestBreaking_DeprecationPathMixed(t *testing.T) {
	...
	require.NotEmpty(t, errs)
	require.Len(t, errs, 1)
	requireChange(t, errs, checker.APIPathRemovedBeforeSunsetId)
...
func TestBreaking_RemoveEndpointWithInvalidSunset(t *testing.T) {
	...
	require.NotEmpty(t, errs)
	require.Len(t, errs, 1)
	requireChange(t, errs, checker.APIPathSunsetParseId)
