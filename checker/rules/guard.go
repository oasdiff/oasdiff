...
const (
	...
	// or header, or the payload that inhabits one. The client chooses the
	// variant, so contravariance applies with request polarity even though
	// the variant lives on the response side.
