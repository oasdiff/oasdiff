...
func TestViper_InvalidTags(t *testing.T) {
	...
	require.EqualError(t, internal.RunViper(&cmd, v), "failed to load config file: invalid tags \"invalid\", allowed values: request, response, add, remove, change, increase, decrease, set, unset, widens, narrows, generalize, specialize, schema, parameters, requestBody, responses, paths, headers, security, tags, components, existence, requiredness, mutability, type, constraints, values, structure, lifecycle")
}
