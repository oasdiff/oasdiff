...
func addCommonBreakingFlags(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().StringSlice("include-stability-levels", nil, "comma-separated list of stability levels to include instead of suppressing (e.g. draft,alpha)")
}
