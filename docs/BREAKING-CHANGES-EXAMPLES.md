...
[message includes sunset date when request property deprecated with valid sunset](../checker/check_request_property_deprecation_test.go?plain=1#L237)  
...
[message reports sunset missing when request property deprecated without sunset](../checker/check_request_property_deprecation_test.go?plain=1#L220)  
