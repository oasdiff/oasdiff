...
[deprecating a request property with invalid stability level uses default deprecation days](../checker/check_request_property_deprecation_test.go?plain=1#L197)  
...
[endpoint deprecation message includes sunset date](../checker/check_api_deprecation_test.go?plain=1#L390)  
...
[message includes sunset date when request property deprecated with valid sunset](../checker/check_request_property_deprecation_test.go?plain=1#L231)  
...
[message reports sunset missing when request property deprecated without sunset](../checker/check_request_property_deprecation_test.go?plain=1#L214)  
