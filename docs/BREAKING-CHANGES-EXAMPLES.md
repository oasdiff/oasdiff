...
[deleting a path with some operations having sunset date in the future is breaking](../checker/check_api_removed_test.go?plain=1#L196)  
[deleting a path without deprecation is breaking](../checker/check_api_removed_test.go?plain=1#L18)  
...
[deleting an operation before sunset date is breaking](../checker/check_api_removed_test.go?plain=1#L63)  
[deleting an operation without deprecation is breaking](../checker/check_api_removed_test.go?plain=1#L29)  
...
[deprecating an operation with a deprecation policy and an invalid stability level is breaking](../checker/check_api_deprecation_test.go?plain=1#L61)  
[deprecating an operation with a deprecation policy and an invalid sunset date is breaking](../checker/check_api_deprecation_test.go?plain=1#L42)  
[deprecating an operation with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_api_deprecation_test.go?plain=1#L170)  
[deprecating an operation with a deprecation policy but without specifying sunset date is breaking](../checker/check_api_deprecation_test.go?plain=1#L97)  
...
[removing a deprecated enpoint with an invalid date is breaking](../checker/check_api_removed_test.go?plain=1#L243)  
...
[removing the path without a deprecation policy and without specifying sunset date is breaking for endpoints with non draft/alpha stability level](../checker/check_api_removed_test.go?plain=1#L143)  
...
[deleting a deprecated operation without sunset date is not breaking](../checker/check_api_removed_test.go?plain=1#L84)  
...
[deleting a path after sunset date of all contained operations is not breaking](../checker/check_api_removed_test.go?plain=1#L181)  
[deleting a path with deprecated operations without sunset date is not breaking](../checker/check_api_removed_test.go?plain=1#L217)  
...
[deleting an operation after sunset date is not breaking](../checker/check_api_removed_test.go?plain=1#L48)  
...
[deprecating an operation with a default deprecation policy but without specifying sunset date is not breaking](../checker/check_api_deprecation_test.go?plain=1#L115)  
[deprecating an operation with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_api_deprecation_test.go?plain=1#L190)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_api_deprecation_test.go?plain=1#L131)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_api_deprecation_test.go?plain=1#L146)  
[deprecating an operation without a deprecation policy but without specifying sunset date is not breaking](../checker/check_api_deprecation_test.go?plain=1#L81)  
...
[removing the path without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_api_removed_test.go?plain=1#L105)  
[removing the path without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_api_removed_test.go?plain=1#L124)  
...
[adding and removing webhooks](../checker/check_webhook_updated_test.go?plain=1#L11)  
[adding contains constraint to request body](../checker/check_request_property_contains_updated_test.go?plain=1#L11)  
[adding contains constraint to request property](../checker/check_request_property_contains_updated_test.go?plain=1#L107)  
[adding contains constraint to response body](../checker/check_response_property_contains_updated_test.go?plain=1#L11)  
[adding contains constraint to response property](../checker/check_response_property_contains_updated_test.go?plain=1#L89)  
[adding contentSchema and changing contentMediaType/contentEncoding in request property](../checker/check_request_property_content_updated_test.go?plain=1#L11)  
[adding contentSchema and changing contentMediaType/contentEncoding in response property](../checker/check_response_property_content_updated_test.go?plain=1#L11)  
[adding dependent schema to request body](../checker/check_request_property_dependent_schemas_updated_test.go?plain=1#L11)  
[adding dependent schema to response body](../checker/check_response_property_dependent_schemas_updated_test.go?plain=1#L11)  
[adding dependentRequired to request body](../checker/check_request_property_dependent_required_changed_test.go?plain=1#L11)  
[adding dependentRequired to request property](../checker/check_request_property_dependent_required_changed_test.go?plain=1#L46)  
[adding dependentRequired to response body](../checker/check_response_property_dependent_required_changed_test.go?plain=1#L11)  
[adding dependentRequired to response property](../checker/check_response_property_dependent_required_changed_test.go?plain=1#L50)  
...
[adding if/then/else to request body](../checker/check_request_property_if_updated_test.go?plain=1#L11)  
[adding if/then/else to response body](../checker/check_response_property_if_updated_test.go?plain=1#L11)  
[adding pattern property to request body](../checker/check_request_property_pattern_properties_updated_test.go?plain=1#L11)  
[adding pattern property to response body](../checker/check_response_property_pattern_properties_updated_test.go?plain=1#L11)  
[adding pattern to request parameters](../checker/check_request_parameter_pattern_added_or_changed_test.go?plain=1#L60)  
[adding prefixItems to request body](../checker/check_request_property_prefix_items_updated_test.go?plain=1#L11)  
[adding prefixItems to response body](../checker/check_response_property_prefix_items_updated_test.go?plain=1#L11)  
[adding propertyNames to request body](../checker/check_request_property_property_names_updated_test.go?plain=1#L11)  
[adding propertyNames to response body](../checker/check_response_property_property_names_updated_test.go?plain=1#L11)  
[adding request body const value or request property const value](../checker/check_request_property_const_changed_test.go?plain=1#L58)  
...
[adding response body const value or response property const value](../checker/check_response_property_const_changed_test.go?plain=1#L41)  
...
[adding unevaluated constraints to request body](../checker/check_request_property_unevaluated_updated_test.go?plain=1#L11)  
[adding unevaluated constraints to request property](../checker/check_request_property_unevaluated_updated_test.go?plain=1#L31)  
[adding unevaluated constraints to response body](../checker/check_response_property_unevaluated_updated_test.go?plain=1#L53)  
[adding unevaluated constraints to response property](../checker/check_response_property_unevaluated_updated_test.go?plain=1#L25)  
...
[changing an existing header param from required to optional](../checker/check_request_parameter_required_value_updated_test.go?plain=1#L56)  
...
[changing dependentRequired on request body](../checker/check_request_property_dependent_required_changed_test.go?plain=1#L33)  
[changing dependentRequired on response body](../checker/check_response_property_dependent_required_changed_test.go?plain=1#L37)  
...
[changing request body const value](../checker/check_request_property_const_changed_test.go?plain=1#L12)  
[changing request body default value](../checker/check_request_property_default_value_changed_test.go?plain=1#L12)  
[changing request body to not nullable](../checker/check_request_property_became_not_nuallable_test.go?plain=1#L138)  
...
[changing request property const value](../checker/check_request_property_const_changed_test.go?plain=1#L34)  
...
[changing request property to not nullable via type array (OpenAPI 3.1)](../checker/check_request_property_became_not_nuallable_test.go?plain=1#L103)  
[changing request property to not nullable](../checker/check_request_property_became_not_nuallable_test.go?plain=1#L12)  
[changing request property to nullable via type array (OpenAPI 3.1)](../checker/check_request_property_became_not_nuallable_test.go?plain=1#L81)  
...
[changing response body const value and response property const value](../checker/check_response_property_const_changed_test.go?plain=1#L12)  
...
[changing write-only required response property to optional](../checker/check_response_property_became_optional_test.go?plain=1#L74)  
...
[decreasing maxContains on request body](../checker/check_request_property_contains_updated_test.go?plain=1#L94)  
[decreasing maxContains on request property](../checker/check_request_property_contains_updated_test.go?plain=1#L172)  
[decreasing maxContains on response body](../checker/check_response_property_contains_updated_test.go?plain=1#L76)  
[decreasing maxContains on response property](../checker/check_response_property_contains_updated_test.go?plain=1#L154)  
...
[decreasing minContains on request body](../checker/check_request_property_contains_updated_test.go?plain=1#L68)  
[decreasing minContains on request property](../checker/check_request_property_contains_updated_test.go?plain=1#L146)  
[decreasing minContains on response body](../checker/check_response_property_contains_updated_test.go?plain=1#L50)  
[decreasing minContains on response property](../checker/check_response_property_contains_updated_test.go?plain=1#L128)  
...
[deprecating an operation with a sunset date in RFC3339 format is properly parsed](../checker/check_api_deprecation_test.go?plain=1#L357)  
...
[increasing maxContains on request body](../checker/check_request_property_contains_updated_test.go?plain=1#L81)  
[increasing maxContains on request property](../checker/check_request_property_contains_updated_test.go?plain=1#L159)  
[increasing maxContains on response body](../checker/check_response_property_contains_updated_test.go?plain=1#L63)  
[increasing maxContains on response property](../checker/check_response_property_contains_updated_test.go?plain=1#L141)  
...
[increasing minContains on request body](../checker/check_request_property_contains_updated_test.go?plain=1#L55)  
[increasing minContains on request property](../checker/check_request_property_contains_updated_test.go?plain=1#L133)  
[increasing minContains on response body](../checker/check_response_property_contains_updated_test.go?plain=1#L37)  
[increasing minContains on response property](../checker/check_response_property_contains_updated_test.go?plain=1#L115)  
...
[message has no details when endpoint deprecated without sunset or stability](../checker/check_api_deprecation_test.go?plain=1#L319)  
...
[message includes both sunset and stability when endpoint deprecated with both](../checker/check_api_deprecation_test.go?plain=1#L299)  
...
[message includes stability when endpoint deprecated with stability but no sunset](../checker/check_api_deprecation_test.go?plain=1#L338)  
...
[message includes sunset details when endpoint deprecated with sunset date](../checker/check_api_deprecation_test.go?plain=1#L280)  
...
[modified webhook operations are covered by existing operation-level checkers](../checker/check_webhook_operation_test.go?plain=1#L11)  
...
[no changes in webhooks should produce no webhook-related changes](../checker/check_webhook_operation_test.go?plain=1#L44)  
...
[no webhook changes](../checker/check_webhook_updated_test.go?plain=1#L35)  
...
[path operations that became deprecated](../checker/check_api_deprecation_test.go?plain=1#L212)  
[path operations that were re-activated](../checker/check_api_deprecation_test.go?plain=1#L235)  
...
[removing contains constraint from request body](../checker/check_request_property_contains_updated_test.go?plain=1#L33)  
[removing contains constraint from request property](../checker/check_request_property_contains_updated_test.go?plain=1#L120)  
[removing contains constraint from response body](../checker/check_response_property_contains_updated_test.go?plain=1#L24)  
[removing contains constraint from response property](../checker/check_response_property_contains_updated_test.go?plain=1#L102)  
[removing dependent schema from request body](../checker/check_request_property_dependent_schemas_updated_test.go?plain=1#L33)  
[removing dependentRequired from request body](../checker/check_request_property_dependent_required_changed_test.go?plain=1#L72)  
[removing dependentRequired from request property](../checker/check_request_property_dependent_required_changed_test.go?plain=1#L59)  
[removing dependentRequired from response body](../checker/check_response_property_dependent_required_changed_test.go?plain=1#L24)  
[removing dependentRequired from response property](../checker/check_response_property_dependent_required_changed_test.go?plain=1#L63)  
...
[removing if/then/else from request body](../checker/check_request_property_if_updated_test.go?plain=1#L32)  
...
[removing pattern property from request body](../checker/check_request_property_pattern_properties_updated_test.go?plain=1#L33)  
[removing prefixItems from request body (reverse)](../checker/check_request_property_prefix_items_updated_test.go?plain=1#L33)  
[removing propertyNames from request body](../checker/check_request_property_property_names_updated_test.go?plain=1#L33)  
[removing request body const value or request property const value](../checker/check_request_property_const_changed_test.go?plain=1#L93)  
...
[removing response body const value or response property const value](../checker/check_response_property_const_changed_test.go?plain=1#L74)  
...
[removing unevaluated constraints from request body](../checker/check_request_property_unevaluated_updated_test.go?plain=1#L59)  
[removing unevaluated constraints from request property](../checker/check_request_property_unevaluated_updated_test.go?plain=1#L45)  
[removing unevaluated constraints from response body](../checker/check_response_property_unevaluated_updated_test.go?plain=1#L11)  
[removing unevaluated constraints from response property](../checker/check_response_property_unevaluated_updated_test.go?plain=1#L39)  
[request body/property exclusiveMaximum decreased](../checker/check_request_property_exclusive_min_max_test.go?plain=1#L31)  
[request body/property exclusiveMaximum set](../checker/check_request_property_exclusive_min_max_test.go?plain=1#L71)  
[request body/property exclusiveMinimum increased, exclusiveMaximum decreased](../checker/check_request_property_exclusive_min_max_test.go?plain=1#L11)  
[request body/property exclusiveMinimum set](../checker/check_request_property_exclusive_min_max_test.go?plain=1#L51)  
[request parameter exclusiveMaximum decreased](../checker/check_request_parameters_exclusive_min_max_test.go?plain=1#L30)  
[request parameter exclusiveMaximum set](../checker/check_request_parameters_exclusive_min_max_test.go?plain=1#L68)  
[request parameter exclusiveMinimum increased](../checker/check_request_parameters_exclusive_min_max_test.go?plain=1#L11)  
[request parameter exclusiveMinimum set](../checker/check_request_parameters_exclusive_min_max_test.go?plain=1#L49)  
[response body/property exclusiveMaximum increased](../checker/check_response_property_exclusive_min_max_test.go?plain=1#L11)  
[response properties that were re-activated](../checker/check_response_property_deprecation_test.go?plain=1#L154)  
[response property became nullable via type array (OpenAPI 3.1)](../checker/check_request_property_became_not_nuallable_test.go?plain=1#L162)  
[response type checker does NOT fire for null-only type changes (OpenAPI 3.1)](../checker/check_request_property_became_not_nuallable_test.go?plain=1#L184)  
...
[type checker does NOT fire for null-only type changes (OpenAPI 3.1)](../checker/check_request_property_became_not_nuallable_test.go?plain=1#L125)  
