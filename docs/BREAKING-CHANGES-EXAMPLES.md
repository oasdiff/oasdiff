...
[deprecating a property with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L127)  
[deprecating a property with a deprecation policy but without specifying sunset date is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L97)  
[deprecating a property with an invalid sunset date format is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L192)  
[deprecating a response property with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L122)  
[deprecating a response property with a deprecation policy but without specifying sunset date is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L92)  
[deprecating a response property with an invalid sunset date format is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L187)  
...
[deprecating a property with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_request_property_deprecation_test.go?plain=1#L149)  
[deprecating a property without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_request_property_deprecation_test.go?plain=1#L113)  
[deprecating a response property with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_response_property_deprecation_test.go?plain=1#L144)  
[deprecating a response property without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_response_property_deprecation_test.go?plain=1#L108)  
...
[deprecating a request property with invalid stability level is skipped (handled in CheckBackwardCompatibility)](../checker/check_request_property_deprecation_test.go?plain=1#L208)  
[deprecating a response property with invalid stability level is skipped (handled in CheckBackwardCompatibility)](../checker/check_response_property_deprecation_test.go?plain=1#L204)  
...
[properties that were re-activated](../checker/check_request_property_deprecation_test.go?plain=1#L170)  
...
[response properties that were re-activated](../checker/check_response_property_deprecation_test.go?plain=1#L165)  
