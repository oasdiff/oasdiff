...
[adding a new operation id](../checker/check_api_operation_id_updated_test.go?plain=1#L87)  
[adding a new optional request property](../checker/check_request_property_updated_test.go?plain=1#L88)  
[adding a new required request property with a default value](../checker/check_request_property_updated_test.go?plain=1#L133)  
...
[changing an existing header param from required to optional](../checker/check_request_parameter_required_value_updated_test.go?plain=1#L59)  
...
[changing optional response write-only property to required](../checker/check_response_property_became_required_test.go?plain=1#L55)  
...
[removing a required request property](../checker/check_request_property_updated_test.go?plain=1#L111)  
