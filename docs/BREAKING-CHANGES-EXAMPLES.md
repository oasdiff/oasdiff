...
[deprecating a property with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L94)  
[deprecating a property with a deprecation policy but without specifying sunset date is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L63)  
[deprecating a property with an invalid sunset date format is breaking](../checker/check_request_property_deprecation_test.go?plain=1#L158)  
[deprecating a response property with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L90)  
[deprecating a response property with a deprecation policy but without specifying sunset date is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L59)  
[deprecating a response property with an invalid sunset date format is breaking](../checker/check_response_property_deprecation_test.go?plain=1#L153)  
...
[deprecating a property with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_request_property_deprecation_test.go?plain=1#L115)  
[deprecating a property without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_request_property_deprecation_test.go?plain=1#L80)  
[deprecating a response property with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_response_property_deprecation_test.go?plain=1#L110)  
[deprecating a response property without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_response_property_deprecation_test.go?plain=1#L76)  
...
[detecting deprecated response properties in allOf schemas](../checker/check_response_property_deprecation_test.go?plain=1#L30)  
[detecting deprecated response properties with sunset date](../checker/check_response_property_deprecation_test.go?plain=1#L14)  
[ensuring no duplicate deprecation reports for the same property](../checker/check_request_property_deprecation_test.go?plain=1#L49)  
[ensuring no duplicate deprecation reports for the same response property](../checker/check_response_property_deprecation_test.go?plain=1#L45)  
...
[message has no details when request property deprecated without sunset or stability](../checker/check_request_property_deprecation_test.go?plain=1#L192)  
[message has no details when response property deprecated without sunset or stability](../checker/check_response_property_deprecation_test.go?plain=1#L187)  
...
[no changes when property is read-only](../checker/check_request_property_type_changed_test.go?plain=1#L280)  
...
[properties that were re-activated](../checker/check_request_property_deprecation_test.go?plain=1#L136)  
...
[response properties that were re-activated](../checker/check_response_property_deprecation_test.go?plain=1#L131)  
