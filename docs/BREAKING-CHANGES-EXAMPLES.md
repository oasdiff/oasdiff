...
[modifying a media type name in response to make it more general is breaking](../checker/check_response_mediatype_name_updated_test.go?plain=1#L26)  
...
[modifying a media type name in response to make it more specific is not breaking](../checker/check_response_mediatype_name_updated_test.go?plain=1#L11)  
